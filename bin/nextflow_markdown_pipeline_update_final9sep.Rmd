...
```{r, out.height = "180px", fig.align = 'center', echo=FALSE}
...
The table below shows the methylation results for the *MGMT* gene. Where Mean Methylation Full: All 98 CpGs in the *MGMT* promoter. Mean Methylation Pyro: Four CpGs included in the *MGMT* pyro kit. Classification by Pyro: Classification of the pyrosequencing array. Classification by Full: Classification of the full methylation array.
